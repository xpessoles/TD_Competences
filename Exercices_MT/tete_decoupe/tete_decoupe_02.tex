\section{Analyse du comportement de la chaîen de mesure}
\begin{obj}
...
\item $\text{sens}_{\text{mot}}$ est la variable binaire indiquant le sens du moteur : $\text{sens}_{\text{mot}}=1$ lorsque $\omage_m>0$ et $\text{sens}_{\text{mot}}=0$ lorsque $\omega_m\leq 0$;
...
\begin{figure}
\includegraphics[width=\linewidth]{dr_02a.png}
...
\begin{figure}
\includegraphics[width=\linewidth]{dr_03.png}
